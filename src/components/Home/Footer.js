            ...
            <Container>
                <Row className="py-3">
                    <Col md={6} className="py-3">
                        ...
                        <h4 className="text-danger">Eco Cleaner Laundry Service</h4>
                        <p className="text-white">Email: ecocleaner.support@gmail.com</p>
                ...
                <div className='footer-bottom d-flex justify-content-center'>
                    <p className='text-secondary'>Copyright &copy; 2022 Developed by Shivam Mishra</p>
                </div>
            </Container>
        </footer>
    );
